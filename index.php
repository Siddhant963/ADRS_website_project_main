...
">
    ...
    <div class="">
    <!-- Carousel -->
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" data-bs-wrap="true">
    <div class="carousel-inner">
        <!-- First Slide -->
        <div class="carousel-item active">
            <img src="./src/assets/images/carausal1.gif" class="d-block custom-carousel-img mx-auto" alt="Carousel Slide 1" loading="lazy">
        </div>
        <!-- Second Slide -->
        <div class="carousel-item">
            <img src="./src/assets/images/carausal2.png" class="d-block custom-carousel-img mx-auto" alt="Carousel Slide 2" loading="lazy">
        </div>
        <!-- Third Slide -->
        <div class="carousel-item">
            <img src="./src/assets/images/carausal30.jpg" class="d-block custom-carousel-img mx-auto" alt="Carousel Slide 3" loading="lazy">
        </div>
        <!-- Fourth Slide with Custom Content -->
        <div class="carousel-item">
            <div style="background-image:url('./src/assets/images/carausal4.webp');" class="d-block custom-carousel-img mx-auto d-flex flex-column justify-content-center">
                <div>
                    <h2 class="text-light my-auto" style="text-align:center;"> You Want to become a 
                        <span class="text-success p-3" style="font-weight:bolder; background-color:white; border-radius:25px;">Software Engineer?</span>
                    </h2>
                    <center>
                        <a href="./Component/Register.php">
                            <button class="btn btn-dark text-light mt-5">Click here</button>
                        </a>
                    </center>
                </div>
            </div>
...
<!-- Bootstrap 5.1 CSS & JS -->
      ...
      <div class="mope bg-dark">
        <div style="margin-top: 20px;" class="ani">
            ...
            <span><button class="btn submit-button"> <a href="./Component/Register.php">Register Now</a></button></span>
        </div>
        </div>
    ...
    <img src="./src/assets/images/ourwork1.gif" alt="Animated Image" />
</div>
                        <div class="working-content">
                            <h3><a href="./Component/Contact.php" class="text-dark" style="text-decoration:none;">Sketch</a></h3>
                ...
                <div class="col">
                    <div class="single-process-item  "style="border: 2px dashed black;">
                        ...
                        <div class="image-container">
    <img src="./src/assets/images/ourwork2.gif" alt="Animated Image" />
</div>
                        <div class="working-content">
                            <h3><a href="./Component/Contact.php" class="text-dark">Creative Process</a></h3>
                ...
                <div class="col">
                    <div class="single-process-item"  style="border: 2px dashed black;">
                        ...
                        <div class="image-container">
    <img src="./src/assets/images/ourwork3.gif" alt="Animated Image" />
</div>
                        <div class="working-content">
                            <h3><a href="./Component/Contact.php" class="text-dark">Development</a></h3>
                ...
                <div class="col">
                    <div class="single-process-item"  style="border: 2px dashed black;">
                        ...
                        <div class="image-container">
    <img src="./src/assets/images/ourwork4.gif" alt="Animated Image" />
</div>
                        <div class="working-content">
                            <h3><a href="./Component/Contact.php" class="text-dark">Final Product</a></h3>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body" style="text-align:center;">
                            ...
                            <button class="btn btn-primary"><a href="./Component/Contact.php" style="text-decoration:none;"  >Learn More</a></button>
                        </div>
                    </div>
                </div>
                <!-- Card 2 -->
    ...
    <div class="Ansh">
        <div class="int-text">
            <h1 style="color: #fff; background-color:#243642; height:5rem; text-align:center">INTERNSHIP</h1>
        </div>
        <div class="int-main">
            <div class="int-box">
                <div class="int-box1">
...
<img src="https://www.raysitworld.com/assets/img/training/web1.gif" class="int-img1">
                    ...
                    <div class="int-name">
                       <a href="./Component/Register.php"> <h6 >Web Development</h6></a>
                    </div>
                </div>
            </div>
...
<img src="https://www.raysitworld.com/assets/img/training/appdev.gif" class="int-img1">
                    ...
                    <div class="int-name">
                        <a href="./Component/Register.php"><h6>App Development</h6></a>
                    </div>
                </div>
            </div>
...
<img src="https://www.raysitworld.com/assets/img/training/web3.gif" class="int-img1">
                    ...
                    <div class="int-name">
                        <a href="./Component/Register.php"><h6>Software Development</h6></a>
                    </div>
                </div>
            </div>
...
<img src="https://www.raysitworld.com/assets/img/training/interior.gif" class="int-img1">
                    ...
                    <div class="int-name">
                        <a href="./Component/Register.php"><h6>Social Media</h6></a>
                    </div>
                </div>
            </div>
...
<img src="https://www.raysitworld.com/assets/img/training/mech.gif" class="int-img1">
                    ...
                    <div class="int-name">
                        <a href="./Component/Register.php"><h6>Digital Marketing</h6></a>
                    </div>
                </div>
            </div>
            ...
            <div class="int-box ">
                <div class="int-box6 ">
                    ...
                    <div class="int-name ">
                        <a href="./Component/Register.php"><h6>Graphic Designing</h6></a>
                    </div>
                </div>
            </div>
        </div>
  ...
  .white-thick-logo {
    ...
    width: 130px; 
      ...
      display: block;
                ...
                <p>Near katangi bypass karmeta Jabalpur, Madhya Pradesh 482004</p>
                <p>Contact No:</p>
                <p>9201347033 , 9076927464</p>
                <p>Email id: adrstechnosoft@gmail.com</p>
            </div>
    
            <div class="column">
                <h3>Quick Links</h3>
                <p><a href="./Component/Contact.php">Website Development</a></p>
                <p><a href="./Component/Contact.php">Software Development</a></p>
                <p><a href="./Component/Contact.php">Graphic Designing</a></p>
                <p><a href="./Component/Contact.php">Mobile APP</a></p>
                <p><a href="./Component/Contact.php">Summer Internship</a></p>
                <p><a href="./Component/Contact.php">Digital marketing</a></p>
                <p><a href="./Component/Contact.php">Vocational Training</a></p>
                <p><a href="./Component/Contact.php">Privacy Policy</a></p>
            </div>
            ...
            <div class="column">
                ...
                <div class="but">
                    <a href="https://www.linkedin.com/company/adrs-technology/ "><p><button><i class="fa-brands iconcolor fa-linkedin-in" style="color: rgb(255, 255, 255);  "></i></button><span style="color:white;">LinkedIn</span></p></a>
                    <a href="http://www.instagram.com/adrstechno?igsh=MWZiNTY0aWdjNWgxMA=="><p><button><i class="fa-brands iconcolor fa-instagram" style="color: rgb(255, 255, 255); "></i></button><span style="color:white;">Instagram</span></p></a>
                    ...
                    <a style="text-decoration:none;" href="https://github.com/adrstechno"><p><button ><i class="fa-brands iconcolor fa-github" style="color: rgb(255, 255, 255); "></i></button><span style="color:white;">Github Account</span></p></a>
                </div>
                <br>
                <div class="end">
